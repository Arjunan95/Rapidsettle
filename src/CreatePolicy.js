        ...
        return (
            <RX.ScrollView style={ styles.scroll }>
                ...
                <RX.Image source={ './src/img/rqlogo.png' } style={ [styles.navrqlogo] } />
                    ...
                    <RX.Button style={ styles.navwelcome2 }>
                   Logout
                    </RX.Button>
                </RX.View>
...
{/*  
   ...
   value={this.state.rules}
           ...
           <button type="button" onClick={this.handleAddShareholder} className="small">Add Rule</button> </div> */}
...
<RX.Picker style={styles.picker}
                ...
                > 
                                                    ...
                                                    <div> */}
                                                      <br></br>
                                                        <div>
                                                            <label for="inputEmail4" style={{color:"#494949",fontFamily:"ProximaNova-Regular",fontSize:"14"}} style={styles.siDeText}>Reference Doctor</label>
                                                        ...
                                                        <div>
                                                            <label for="inputPassword4" style={{color:"#494949",fontFamily:"ProximaNova-Regular",fontSize:"14"}} style={styles.siDeText}>IPD number</label>
                                                    ...
                                                    {/* <label for="inputPassword4" style={{color:"#494949",fontFamily:"ProximaNova-Regular",fontSize:"14"}} style={styles.siDeText}>Date of Discharge</label>
                                                        ...
                                                        <label for="" style={{color:"#494949",fontFamily:"ProximaNova-Regular",fontSize:"14"}} style={styles.siDeText}>Date of Discharge</label>
                                                        <RX.TextInput
                                                            style={styles.Form}
                                                            placeholder=""
...
<h2 style={{color:"#1f305d",fontSize:20}}><b>Discharge Summary Report</b></h2>
</div>
<br></br>
    <form>
            ...
            <div class="container" style={styles.pack}>
                ...
                {/* <label style={{color:"#494949"}}> Baby's Details    :  {this.state.BaBys_Details}  </label> <br></br> */}
